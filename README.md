...
STACK: Next.js 14 • TypeScript • Supabase
      • Stripe • Redis • Docker
Mission: Building a trust layer for buyers and sellers in social commerce ecosystems with secure escrow services and dispute resolution.

</td> <td width="50%">
🏠 GET A KEJA
Real Estate PWA Platform
text
STATUS: PRODUCTION
STACK: Next.js • TypeScript • TailwindCSS
      • Supabase • Paystack • Redis
Live Deployment
Multi-tenant platform connecting tenants and landlords with RBAC, automated reminders, and real-time analytics.
...
STACK: React Native • Flutter • Supabase
      • Cloud Storage • Real-time CDN
Anonymous storytelling platform with advanced privacy features including voice modulation and face-blurring logic.
